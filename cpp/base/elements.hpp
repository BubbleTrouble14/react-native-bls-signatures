...
public:
    ...
    static G1Element FromMessage(const std::vector<uint8_t>& message, const uint8_t* dst, int dst_len);
    static G1Element FromMessage(Bytes message, const uint8_t* dst, int dst_len);
...
public:
    ...
    static G2Element FromMessage(const std::vector<uint8_t>& message, const uint8_t* dst, int dst_len);
    static G2Element FromMessage(Bytes message, const uint8_t* dst, int dst_len);
