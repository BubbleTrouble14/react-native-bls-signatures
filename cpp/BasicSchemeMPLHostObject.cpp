...
// Constructor
BasicSchemeMPLHostObject::BasicSchemeMPLHostObject() { }

// Destructor
BasicSchemeMPLHostObject::~BasicSchemeMPLHostObject() { }

std::vector<jsi::PropNameID> BasicSchemeMPLHostObject::getPropertyNames(jsi::Runtime& rt)
{
...
jsi::Value BasicSchemeMPLHostObject::get(jsi::Runtime& runtime, const jsi::PropNameID& propNameId)
{
    auto propName = propNameId.utf8(runtime);
    auto funcName = "BasicSchemeMPL." + propName;
    ...
    if (propName == "skToG1") {
        return jsi::Function::createFromHostFunction(runtime, jsi::PropNameID::forAscii(runtime, funcName), 1,
            [](jsi::Runtime& runtime, const jsi::Value& Value, const jsi::Value* arguments,
                ...
                if (count != 1) {
                    throw jsi::JSError(
                        runtime, "skToG1(..) expects one argument (privateKey) of type PrivateKeyHostObject!");
                }
    ...
    if (propName == "sign") {
        return jsi::Function::createFromHostFunction(runtime, jsi::PropNameID::forAscii(runtime, funcName),
            ...
            [](jsi::Runtime& runtime, const jsi::Value& Value, const jsi::Value* arguments,
                ...
                if (count != 2) {
                    throw jsi::JSError(
                        runtime, "sign(..) expects two arguments (privateKey, message) of appropriate types!");
                }
    ...
    if (propName == "verify") {
        return jsi::Function::createFromHostFunction(runtime, jsi::PropNameID::forAscii(runtime, funcName),
            ...
            [](jsi::Runtime& runtime, const jsi::Value& Value, const jsi::Value* arguments,
                ...
                if (count != 3) {
                    throw jsi::JSError(
                        runtime, "verify(..) expects three arguments (pk, message, prependPk) of appropriate types!");
                }
                ...
                auto value = BasicSchemeMPL().Verify(pk, message, prependPk);
    ...
    if (propName == "aggregate") {
        return jsi::Function::createFromHostFunction(runtime, jsi::PropNameID::forAscii(runtime, funcName),
            ...
            [](jsi::Runtime& runtime, const jsi::Value& Value, const jsi::Value* arguments,
                ...
                // Assuming BasicSchemeMPL().Aggregate() returns a G2Element, but  is just an example.
    ...
    if (propName == "aggregateVerify") {
        return jsi::Function::createFromHostFunction(runtime, jsi::PropNameID::forAscii(runtime, funcName),
            ...
            [](jsi::Runtime& runtime, const jsi::Value& Value, const jsi::Value* arguments,
                ...
                // pks
                if (!arguments[0].isObject() || !arguments[0].asObject(runtime).isArray(runtime)) {
                    throw jsi::JSError(runtime, "Expected first argument to be an array of G1ElementHostObjects!");
                }
                ...
                if (!arguments[1].isObject() || !arguments[1].asObject(runtime).isArray(runtime)) {
                    throw jsi::JSError(runtime, "Expected second argument to be an array of Uint8Array!");
                }
                ...
                auto value = BasicSchemeMPL().AggregateVerify(g1Elements, messages, sig);
    ...
    if (propName == "deriveChildPkUnhardened") {
        return jsi::Function::createFromHostFunction(runtime, jsi::PropNameID::forAscii(runtime, funcName),
            ...
            [](jsi::Runtime& runtime, const jsi::Value& Value, const jsi::Value* arguments,
                ...
                G1Element dG1Element = BasicSchemeMPL().DeriveChildPkUnhardened(g1Element, index);
