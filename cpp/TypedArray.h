...
// Copied & Adapted from
// https://github.com/expo/expo/blob/main/packages/expo-gl/common/EXTypedArrayApi.cpp
// Credits to Expo
...
// Instance of this class will invalidate PropNameIDCache when destructor is
// called. Attach this object to global in specific jsi::Runtime to make sure
// lifecycle of the cache object is connected to the lifecycle of the js runtime
