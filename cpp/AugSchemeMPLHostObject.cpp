            ...
            [](jsi::Runtime& runtime, const jsi::Value& Value, const jsi::Value* arguments,
                ...
                if (count != 3) {
                    throw jsi::JSError(runtime,
                        "signPrepend(..) expects three arguments (privateKey, message, prependPk) of appropriate "
                        "types!");
                }
                ...
                if (!privateKeyObject.isHostObject<PrivateKeyHostObject>(runtime)) {
                    throw jsi::JSError(
                        runtime, "signPrepend first argument is an object, but not of type PrivateKeyHostObject!");
                }
                auto privateKeyHostObject = privateKeyObject.getHostObject<PrivateKeyHostObject>(runtime);
                PrivateKey privateKey = privateKeyHostObject->getPrivateKey();
                ...
                if (!isTypedArray(runtime, typeArrayObject)) {
                    throw jsi::JSError(
                        runtime, "signPrepend second argument is an object, but not of type Uint8Array!");
                }
                auto messageArray = getTypedArray(runtime, typeArrayObject);
                vector<uint8_t> message = messageArray.toVector(runtime);
                ...
                if (!g1ElementObject.isHostObject<G1ElementHostObject>(runtime)) {
                    throw jsi::JSError(
                        runtime, "signPrepend third argument is an object, but not of type G1ElementHostObject!");
                }
    ...
    if (propName == "deriveChildSk") {
        return jsi::Function::createFromHostFunction(runtime, jsi::PropNameID::forAscii(runtime, funcName), 2,
            [](jsi::Runtime& runtime, const jsi::Value& Value, const jsi::Value* arguments,
                ...
                if (!privateKeyObject.isHostObject<PrivateKeyHostObject>(runtime)) {
                    throw jsi::JSError(
                        runtime, "deriveChildSk first argument is an object, but not of type PrivateKey!");
                }
                auto privateKeyHostObject = privateKeyObject.getHostObject<PrivateKeyHostObject>(runtime);
                PrivateKey privateKey = privateKeyHostObject->getPrivateKey();
    ...
    if (propName == "deriveChildSkUnhardened") {
        return jsi::Function::createFromHostFunction(runtime, jsi::PropNameID::forAscii(runtime, funcName), 2,
            [](jsi::Runtime& runtime, const jsi::Value& Value, const jsi::Value* arguments,
                ...
                if (!privateKeyObject.isHostObject<PrivateKeyHostObject>(runtime)) {
                    throw jsi::JSError(
                        runtime, "deriveChildSkUnhardened first argument is an object, but not of type PrivateKey!");
                }
                auto privateKeyHostObject = privateKeyObject.getHostObject<PrivateKeyHostObject>(runtime);
                PrivateKey privateKey = privateKeyHostObject->getPrivateKey();
    ...
    if (propName == "deriveChildPkUnhardened") {
        return jsi::Function::createFromHostFunction(runtime, jsi::PropNameID::forAscii(runtime, funcName), 2,
            [](jsi::Runtime& runtime, const jsi::Value& Value, const jsi::Value* arguments,
                ...
                if (!g1ElementObject.isHostObject<G1ElementHostObject>(runtime)) {
                    throw jsi::JSError(
                        runtime, "deriveChildPkUnhardened first argument is an object, but not of type PrivateKey!");
                }
                auto g1ElementHostObject = g1ElementObject.getHostObject<G1ElementHostObject>(runtime);
                G1Element g1Element = g1ElementHostObject->getG1Element();
